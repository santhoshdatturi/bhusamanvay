...
export function ApiKeysView({ initialKeys, user }: ApiKeysViewProps) {
  ...
  const revokedCount = keys.filter((k) => Boolean(k.revokedAt)).length;
        ...
        <div className="flex flex-col gap-1.5">
          <div className="flex items-center gap-2.5 flex-wrap">
            ...
            <Badge
              ...
              className="text-[11px] font-mono uppercase px-2 py-0.5 tracking-wider"
            >
              {user.role}
            </Badge>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="rounded-xl border border-border/60 bg-card p-5 flex flex-col gap-2 shadow-xs hover:border-border transition-colors">
          <div className="flex items-center justify-between">
            ...
            <HugeiconsIcon icon={CheckmarkCircle02Icon} className="size-4 text-muted-foreground" strokeWidth={1.8} />
          </div>
          <div className="text-2xl sm:text-3xl font-bold tracking-tight text-foreground font-sans tabular-nums">
            {activeCount}
          </div>
        ...
        <Card className="rounded-xl border border-border/60 bg-card p-5 flex flex-col gap-2 shadow-xs hover:border-border transition-colors">
          <div className="flex items-center justify-between">
            ...
            <HugeiconsIcon icon={Alert02Icon} className="size-4 text-muted-foreground" strokeWidth={1.8} />
          </div>
          <div className="text-2xl sm:text-3xl font-bold tracking-tight text-foreground font-sans tabular-nums">
            {revokedCount}
          </div>
